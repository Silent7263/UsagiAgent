...
import com.buaa.usagi.converter.AgentConverter;
import com.buaa.usagi.converter.ChatMessageConverter;
import com.buaa.usagi.converter.KnowledgeBaseConverter;
import com.buaa.usagi.mapper.AgentMapper;
import com.buaa.usagi.mapper.KnowledgeBaseMapper;
import com.buaa.usagi.model.dto.AgentDTO;
import com.buaa.usagi.model.dto.ChatMessageDTO;
import com.buaa.usagi.model.dto.KnowledgeBaseDTO;
import com.buaa.usagi.model.entity.Agent;
import com.buaa.usagi.model.entity.KnowledgeBase;
import com.buaa.usagi.service.ChatMessageFacadeService;
import com.buaa.usagi.service.SseService;
...
public class ChatFactory {
    ...
    private static final Logger log = LoggerFactory.getLogger(ChatFactory.class);
    ...
    private Chat buildAgentRuntime(
            Agent agent,
            List<Message> memory,
     ...
     * 创建一个 Chat 实例
     */
    public Chat create(String agentId, String chatSessionId) {
