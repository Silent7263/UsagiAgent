...
import com.buaa.usagi.mapper.ChatMessageMapper;
import com.buaa.usagi.model.dto.ChatMessageDTO;
import com.buaa.usagi.model.entity.ChatMessage;
...
public class ChatMessageFacadeServiceImpl implements ChatMessageFacadeService {
    ...
    public List<ChatMessageDTO> getChatMessagesBySessionIdRecently(String sessionId, int limit) {
        ...
        // SQL 按 created_at 倒序取最近 limit 条，这里反转回时间正序（旧 -> 新），
        // 保证 Agent 加载到的记忆是「最近的连续对话」
